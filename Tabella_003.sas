...
DATA TMP1_&anno.; SET ARCIPELAGO3; RUN; 
DATA ARCIPELAGO_003; SET TMP_2016 TMP_2017 TMP_2018 TMP1_2018; RUN; 
...
data arcipelago_003; set arcipelago_003; 
if (anno_a3=2017 and anno_chiusura_imp <2017 ) then anno_chiusura_imp = .  ; 
if (anno_a3=2018 and anno_chiusura_imp <2018 ) then anno_chiusura_imp = .  ;
run; 
